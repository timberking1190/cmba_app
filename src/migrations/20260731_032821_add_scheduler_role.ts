...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_users_roles" ADD VALUE 'scheduler' BEFORE 'club_admin';
  ALTER TYPE "public"."enum_certification_types_applies_to_roles" ADD VALUE 'scheduler' BEFORE 'club_admin';
  ALTER TYPE "public"."enum_certification_types_required_for_roles" ADD VALUE 'scheduler' BEFORE 'club_admin';
  ALTER TYPE "public"."enum_courses_required_for_roles" ADD VALUE 'scheduler' BEFORE 'club_admin';
  ALTER TYPE "public"."enum_member_card_config_scannable_roles" ADD VALUE 'scheduler' BEFORE 'club_admin';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_roles" AS ENUM('participant', 'coach', 'official', 'parent', 'league_official', 'club_admin', 'super_admin');
  ...
  CREATE TYPE "public"."enum_certification_types_applies_to_roles" AS ENUM('participant', 'coach', 'official', 'parent', 'league_official', 'club_admin', 'super_admin');
  ...
  CREATE TYPE "public"."enum_certification_types_required_for_roles" AS ENUM('participant', 'coach', 'official', 'parent', 'league_official', 'club_admin', 'super_admin');
  ...
  CREATE TYPE "public"."enum_courses_required_for_roles" AS ENUM('participant', 'coach', 'official', 'parent', 'league_official', 'club_admin', 'super_admin');
  ...
  CREATE TYPE "public"."enum_member_card_config_scannable_roles" AS ENUM('participant', 'coach', 'official', 'parent', 'league_official', 'club_admin', 'super_admin');
