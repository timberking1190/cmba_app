  ...
  return (
    <div className="max-w-6xl mx-auto px-4 lg:px-6 py-10">
      ...
      <div className="flex gap-4 mt-4 mb-6">
        <div className="bg-cmba-black-card border border-white/12 px-4 py-2">
        ...
        <div className={`bg-cmba-black-card border px-4 py-2 ${flagged ? 'border-red-500/40' : 'border-green-500/30'}`}>
